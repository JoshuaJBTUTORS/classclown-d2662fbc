...
-- Insert transcription record for this lesson (using correct column names)
...
-- Get the transcription ID for the summaries
DO $$
DECLARE
...
BEGIN
    ...
    WHERE lesson_id = 'd1234567-89ab-cdef-0123-456789abcdef' 
    LIMIT 1;
