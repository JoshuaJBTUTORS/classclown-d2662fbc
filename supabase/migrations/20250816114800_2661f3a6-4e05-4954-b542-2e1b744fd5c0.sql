...
INSERT INTO daily_processing_logs (
  processing_date,
  status,
  lessons_found,
  transcriptions_retrieved,
  error_details
) VALUES (
  CURRENT_DATE,
  'cleanup_completed',
  ...
  0,
  jsonb_build_object(
    'operation', 'duplicate_transcript_cleanup',
    'timestamp', NOW(),
    'message', 'Removed duplicate transcript records and added unique constraint'
  )
);