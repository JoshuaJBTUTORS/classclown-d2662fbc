-- Sync AI marking results to assessment_sessions for exam week results
-- This updates total_marks_achieved and total_marks_available from student_responses
