...
export const DoodleFilm: React.FC<DoodleProps> = (props) => (
  <svg {...base} width={22} height={22} {...props}>
    ...
    <path d="M5.6 6.4l1.6 1.8M9.6 5.6l1.2 2.4M13.8 5.6l1.2 2.4M18 6.4l-1.4 1.6" />
    <path d="M7 12.2h6M7 15h8" />
  </svg>
);
...
export const DoodleCoin: React.FC<DoodleProps> = (props) => (
  <svg {...base} width={22} height={22} {...props}>
    ...
    <path d="M12 8.6v6.8M10.4 10.2h2.2c.7 0 1.2.4 1.2 1 0 .6-.5 1-1.2 1H10.6c.8.2 1.4.5 1.4 1.2" />
  </svg>
);
