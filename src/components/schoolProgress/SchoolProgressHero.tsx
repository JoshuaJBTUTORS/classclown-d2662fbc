...
export const SchoolProgressHero: React.FC<SchoolProgressHeroProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-[1.5rem] bg-pastel-butter px-6 py-8 shadow-[var(--shadow-soft)] sm:px-10 sm:py-10">
      <ScribbleStroke className="pointer-events-none absolute -right-6 -top-10 h-48 w-72 text-foreground/15" />

      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="space-y-3">
          <h1 className="font-heading text-3xl font-extrabold tracking-tight text-pastel-butter-foreground sm:text-4xl lg:text-5xl">
            School Progress
          </h1>
          <p className="max-w-xl text-sm text-pastel-butter-foreground/75 sm:text-base">
            Upload and view report cards, mock exam results, and other school documents.
          </p>

          <div className="flex flex-wrap items-center gap-3 pt-1">
            <div className="rounded-full bg-background/70 px-5 py-2.5 shadow-[var(--shadow-soft)]">
              <span className="font-heading text-lg font-extrabold tracking-tight text-pastel-butter-foreground">
                {documentCount}
              </span>
              <span className="ml-2 text-sm text-pastel-butter-foreground/75">
