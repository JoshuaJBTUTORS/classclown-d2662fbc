    ...
    if (conversationId && questionBlock) {
      try {
        ...
        if (markingResult) {
          ...
          if (percentage >= 75) {
            toast.success('🪙 +2 coins earned!', { description: 'Excellent answer!', duration: 2000 });
          } else if (percentage >= 50) {
            toast.success('🪙 +1 coin earned!', { description: 'Good effort!', duration: 2000 });
          }
        } else if (isCorrect) {
          toast.success('🪙 +2 coins earned!', { description: 'Keep going to unlock mastery levels!', duration: 2000 });
        }
      } catch (error) {
